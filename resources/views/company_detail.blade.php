                    ...
                    <div id="all">
                        ...
                        <form action="" method="post">
                            ...
                            <table style="width: 50%; float:left">
                                <tr>
                                    <td>Company</td>
                                    <td><input type="text" style="width: 80px;color: gray" value="" name="cpn_id"
                                               readonly>
                                        <input type="text" style="color: gray" value="" name="cpn_name" readonly></td>
                                </tr>
                                <tr>
                                    <td>Address</td>
                                    <td><input id="address" style="width: 300px" type="text" value="" name="address"
                                               required></td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                                    <td><input id="address" type="email" value="" name="email" required></td>
                                </tr>
                                <tr>
                                    <td>Phone</td>
                            ...
                            <div id="image" style="width:30%;float:right;margin-bottom: 150px">
                                ...
                                <img src="{{asset('img/avatar5.jpeg'}}'" style="clip-path: circle(50%);display:inline-block;height:100px;">
                            </div>
