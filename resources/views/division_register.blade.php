                    ...
                    <div id="all">
                        ...
                        <form action="" method="post">
                            ...
                            <table style="width: 50%; float:left">
                                <tr>
                                    <td>Company</td>
                                    <td><input type="text" style="width: 80px;color: gray" placeholder="Company code"  name="cpn_id">
                                        <input type="text"  name="cpn_name" placeholder="Company name" ></td>
                                </tr>
                                <tr>
                                    <td>Branch Name</td>
                                    <td><input type="text" style="width: 80px;color: gray" placeholder="Branch code"  name="br_id">
                                        <input type="text"  name="br_name" placeholder="Branch name" ></td>
                                </tr>
                                <tr>
                                    <td>Division</td>
                                    <td><input id="name" style="width: 300px" type="text" placeholder="Please enter Division Name" name="name" required></td>
                                </tr>
                                <tr>
                                    <td>Project</td>
                                    <td><input  style="width: 300px" type="text" placeholder="Please enter project Name" name="project" required></td>
                                </tr>
                                <tr>
                                    <td>PM</td>
                                    <td><select>
