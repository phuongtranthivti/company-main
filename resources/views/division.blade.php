                    ...
                    <div id="all">
                        ...
                        <form action="" method="get">
                            <table>
                                <tr>
                                    <td>Company</td>
                                    <td><input id="company" style="width: 100px" type="text" placeholder="Company code" name="cpn_id">
                                        <input type="text" placeholder="Please enter Company name" name="cpn_name"></td>
                                </tr>
                                <tr>
                                    <td>Branch(Optional)</td>
                                    <td><input style="width: 100px" type="text" placeholder="Branch code" name="br_id">
                                        <input type="text" placeholder="Please enter Branch name" name="br_name"></td>
                                </tr>
                                <tr>
                                    <td>Division</td>
                                    <td><input style="width: 100px" type="text" placeholder="Division code" name="id">
                                        <input type="text" placeholder="Please enter Division name" name="name"></td>
                                </tr>
                                <tr>
                                    <td>Email</td>
