                        ...
                        <form action="" method="get">
                            <table>
                                <tr style="margin-top: 20px">
                                    <td >Company</td>
                                    <td><input id="company" style="width: 100px" type="text" placeholder="Company code" name="id">
                                        <input type="text" placeholder="Please enter Company name" name="name"></td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                            ...
                            <div id="body_button">
                                <a href="#" style="text-decoration: none;    margin-left: 10px;width: 400px">
